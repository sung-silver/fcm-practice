...
import static com.practice.fcm.common.exception.ErrorType.FAIL_TO_SEND_PUSH_ALARM;
...
public class FCMService {
    ...
    @Value("${fcm.key.scope}") private String scope;
    ...
    public void pushAlarm(FCMPushRequest request) {
        Message message = makeSingleMessage(request);
    ...
    public void multipleSendByToken(FCMPushRequest request, List<Member> members, String topic) {
        ...
        try {
            ...
            throw new IllegalArgumentException(FAIL_TO_SEND_PUSH_ALARM.getMessage());
        }
    }
    ...
    private Message makeTopicMessage(FCMPushRequest request) {
        Notification notification = getNotification(request);
        return Message.builder()
            .setTopic(topic)
            .setNotification(notification)
    ...
    private void sendPushMessage(Message message) {
        try {
            ...
            throw new CustomException(FAIL_TO_SEND_PUSH_ALARM);
        }
    }
